...
class FormalityAnalyzer {
    constructor() {
        this.informalWords = [
            'gonna', 'wanna', 'gotta', 'kinda', 'sorta', 'yeah', 'ok', 'okay', 'cool', 'awesome',
            'super', 'really', 'pretty', 'quite', 'totally', 'definitely', 'basically', 'literally',
            'obviously', 'seriously', 'actually', 'honestly', 'frankly', 'personally', 'anyway',
            'whatever', 'stuff', 'things', 'guys', 'folks', 'y\'all', 'you\'ll', 'we\'ll', 'they\'ll',
            'can\'t', 'won\'t', 'don\'t', 'isn\'t', 'aren\'t', 'wasn\'t', 'weren\'t', 'haven\'t',
            'hasn\'t', 'hadn\'t', 'wouldn\'t', 'couldn\'t', 'shouldn\'t'
        ];
        
        this.informalPhrases = [
            'a bunch of', 'a lot of', 'tons of', 'loads of', 'heaps of', 'no big deal',
            'piece of cake', 'walk in the park', 'right off the bat', 'get the ball rolling',
            'hit the ground running', 'think outside the box', 'low-hanging fruit'
        ];
    ...
    analyzeText() {
        ...
        const desiredFormality = parseInt(document.getElementById('formalitySlider').value);
    ...
    displayResults(analysis, desiredFormality) {
        ...
        const comparison = analysis.currentScore >= desiredFormality ? 
            ' (Meets desired level)' : 
