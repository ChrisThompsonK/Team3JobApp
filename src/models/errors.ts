...
export const createHttpError = {
	badRequest: (message = "Bad Request") =>
		new HttpError(message, HttpStatusCode.BAD_REQUEST),
	unauthorized: (message = "Unauthorized") =>
		new HttpError(message, HttpStatusCode.UNAUTHORIZED),
	forbidden: (message = "Forbidden") =>
		new HttpError(message, HttpStatusCode.FORBIDDEN),
	notFound: (message = "Not Found") =>
		new HttpError(message, HttpStatusCode.NOT_FOUND),
	methodNotAllowed: (message = "Method Not Allowed") =>
		new HttpError(message, HttpStatusCode.METHOD_NOT_ALLOWED),
	conflict: (message = "Conflict") =>
		new HttpError(message, HttpStatusCode.CONFLICT),
	...
	badGateway: (message = "Bad Gateway") =>
		new HttpError(message, HttpStatusCode.BAD_GATEWAY),
